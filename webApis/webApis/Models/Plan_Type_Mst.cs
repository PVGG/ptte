...
namespace PTEWebService.Models
{
    public class Plan_Type_Mst
    {
        ...
        #region Get All Plan Type
        public string GetAllPlanType()
        {
            try
            {
                connection();
                com = new SqlCommand("prManagePlan_type_mst", con);
        ...
        #endregion
        #region Get Plan Type from Index ID
        public string GetPlanType(int id)
        {
            try
            {
                connection();
        ...
        #endregion
        #region Insert Plan Type
        public string AddPlanType(string name,int user_id)
        {
            connection();
            com = new SqlCommand("prManagePlan_type_mst", con);
            com.CommandType = CommandType.StoredProcedure;
            com.Parameters.AddWithValue("@Action", "Insert");
            com.Parameters.AddWithValue("@plan_type_name", name);
        ...
        #endregion
        #region Update Plan Type
        public string EditPlanType(int index_id, string name,int user_id)
        {
            connection();
            com = new SqlCommand("prManagePlan_type_mst", con);
            com.CommandType = CommandType.StoredProcedure;
        ...
        public string DeletePlanType(int index_id)
        {
            connection();
            com = new SqlCommand("prManagePlan_type_mst", con);
            com.CommandType = CommandType.StoredProcedure;
