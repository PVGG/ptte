...
namespace PTEWebService.Models
{
    public class Country_Mst
    {
        ...
        public string GetAllCountry()
        {
            ...
            {
                connection();
                com = new SqlCommand("prManagecountry_mst", con);
        ...
        #endregion
        #region Get Country from Index ID
        ...
        public string AddCountry(string name,int user_id)
        {
            connection();
            com = new SqlCommand("prManagecountry_mst", con);
            com.CommandType = CommandType.StoredProcedure;
            com.Parameters.AddWithValue("@Action", "Insert");
            com.Parameters.AddWithValue("@country_name", name);
        ...
        public string EditCountry(int index_id, string name,int user_id)
        {
            connection();
            com = new SqlCommand("prManagecountry_mst", con);
            com.CommandType = CommandType.StoredProcedure;
        ...
        public string DeleteCountry(int index_id)
        {
            connection();
            com = new SqlCommand("prManagecountry_mst", con);
            com.CommandType = CommandType.StoredProcedure;
