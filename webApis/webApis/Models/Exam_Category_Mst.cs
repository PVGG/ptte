...
{
    public class Exam_Category_Mst
    {
        ...
        #region Get All Exam Categary
        public string GetAllExamCategary()
        {
            try
            {
                connection();
                com = new SqlCommand("prManageExam_category_mst", con);
        ...
        #endregion
        #region Get Exam Categary from Index ID
        public string GetExamCategary(int id)
        {
            try
            {
                connection();
        ...
        #endregion
        #region Insert Exam Categary
        public string AddExamCategary(string name,int user_id)
        {
            connection();
            com = new SqlCommand("prManageExam_category_mst", con);
            com.CommandType = CommandType.StoredProcedure;
            com.Parameters.AddWithValue("@Action", "Insert");
            com.Parameters.AddWithValue("@exam_category_name", name);
        ...
        #endregion
        #region Update Exam Categary
        public string EditExamCategary(int index_id, string name,int user_id)
        {
            connection();
            com = new SqlCommand("prManageExam_category_mst", con);
            com.CommandType = CommandType.StoredProcedure;
        ...
        #endregion
        #region Delete Exam Categary
        public string DeleteExamCategary(int index_id)
        {
            connection();
            com = new SqlCommand("prManageExam_category_mst", con);
            com.CommandType = CommandType.StoredProcedure;
