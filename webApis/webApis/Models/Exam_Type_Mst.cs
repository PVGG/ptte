...
namespace PTEWebService.Models
{
    public class Exam_Type_Mst
    {
        ...
        public string GetAllExamType()
        {
            ...
            {
                connection();
                com = new SqlCommand("prManageExam_type_mst", con);
        ...
        public string AddExamType(string name,int user_id)
        {
            connection();
            com = new SqlCommand("prManageExam_type_mst", con);
            com.CommandType = CommandType.StoredProcedure;
            com.Parameters.AddWithValue("@Action", "Insert");
            com.Parameters.AddWithValue("@exam_type_name", name);
        ...
        public string EditExamType(int index_id, string name,int user_id)
        {
            connection();
            com = new SqlCommand("prManageExam_type_mst", con);
            com.CommandType = CommandType.StoredProcedure;
